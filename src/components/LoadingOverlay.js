...
export function LoadingOverlay({ show, variant, label, }) {
    ...
    return createPortal(_jsx("div", { className: styles.root, role: "status", "aria-live": "polite", "aria-busy": "true", "aria-label": aria, children: variant === "data" ? (_jsxs("div", { className: styles.dataColumn, children: [_jsx("p", { className: styles.caption, children: "\u8F09\u5165\u4E2D...\u55B5" }), _jsx("div", { className: styles.flyArena, "aria-hidden": "true", children: _jsx(DotLottieReact, { src: LOTTIE_LOADING_DATA, autoplay: true, loop: true, className: styles.lottieFly }) })] })) : (_jsxs("div", { className: styles.submitColumn, children: [_jsx("p", { className: styles.caption, children: "\u6EFE\u52D5\u5F0F\u8ABF\u6574\u4E2D...." }), _jsx("div", { className: `${styles.stage} ${styles.roll}`, "aria-hidden": "true", children: _jsx(DotLottieReact, { src: LOTTIE_LOADING_SUBMIT, autoplay: true, loop: true, className: styles.lottie }) })] })) }), document.body);
}
