export const MONTHLY_THEMES = {
    1: {
        ...
        colors: {
            bg: "#fff5ee",
            bgSoft: "#ffe8d6",
            bgPattern: "radial-gradient(circle at 12% 18%, rgba(231, 105, 92, 0.16) 0, transparent 45%),\n   radial-gradient(circle at 85% 75%, rgba(243, 169, 86, 0.18) 0, transparent 42%)",
            surface: "#fffdf6",
            border: "#f3d6b8",
            borderSoft: "#fde9d2",
            text: "#5a2f24",
    ...
    2: {
        ...
        colors: {
            bg: "#fff5f7",
            bgSoft: "#ffe1ea",
            bgPattern: "radial-gradient(circle at 18% 20%, rgba(233, 137, 169, 0.22) 0, transparent 48%),\n   radial-gradient(circle at 82% 80%, rgba(247, 184, 200, 0.22) 0, transparent 45%)",
            surface: "#fffafc",
            border: "#f5cad8",
            borderSoft: "#ffe1ea",
            text: "#5b2a3c",
    ...
    3: {
        ...
        colors: {
            bg: "#fff7fa",
            bgSoft: "#ffe5ee",
            bgPattern: "radial-gradient(circle at 12% 18%, rgba(243, 200, 220, 0.32) 0, transparent 48%),\n   radial-gradient(circle at 85% 72%, rgba(186, 215, 154, 0.22) 0, transparent 48%)",
            surface: "#fffcfe",
            border: "#f3c8da",
            borderSoft: "#ffe1ec",
            text: "#5b3949",
    ...
    4: {
        ...
        colors: {
            bg: "#fbfaee",
            bgSoft: "#f3eed3",
            bgPattern: "radial-gradient(circle at 12% 18%, rgba(177, 198, 124, 0.25) 0, transparent 50%),\n   radial-gradient(circle at 85% 70%, rgba(243, 211, 142, 0.22) 0, transparent 48%)",
            surface: "#fffcef",
            border: "#e0d8b0",
            borderSoft: "#efeacb",
            text: "#3f4a23",
    ...
    5: {
        ...
        colors: {
            bg: "#f7faf0",
            bgSoft: "#e6efc7",
            bgPattern: "radial-gradient(circle at 12% 18%, rgba(127, 168, 107, 0.18) 0, transparent 45%),\n   radial-gradient(circle at 85% 75%, rgba(243, 180, 119, 0.16) 0, transparent 42%)",
            surface: "#fbfaee",
            border: "#d7d6ab",
            borderSoft: "#e9e6c0",
            text: "#3d4b33",
    ...
    6: {
        ...
        colors: {
            bg: "#f1f6fa",
            bgSoft: "#dde9f3",
            bgPattern: "radial-gradient(circle at 12% 18%, rgba(140, 180, 217, 0.24) 0, transparent 48%),\n   radial-gradient(circle at 85% 72%, rgba(193, 173, 217, 0.22) 0, transparent 48%)",
            surface: "#f9fbfd",
            border: "#c7d4e0",
            borderSoft: "#dde9f3",
            text: "#2e3a4a",
    ...
    7: {
        ...
        colors: {
            bg: "#eef7fb",
            bgSoft: "#cfeaf3",
            bgPattern: "radial-gradient(circle at 12% 18%, rgba(94, 168, 199, 0.22) 0, transparent 48%),\n   radial-gradient(circle at 85% 72%, rgba(243, 196, 110, 0.20) 0, transparent 48%)",
            surface: "#f5fbfd",
            border: "#bfdce6",
            borderSoft: "#d8ecf2",
            text: "#1f3e4a",
    ...
    8: {
        ...
        colors: {
            bg: "#fff7f5",
            bgSoft: "#ffe1d8",
            bgPattern: "radial-gradient(circle at 12% 18%, rgba(243, 137, 121, 0.20) 0, transparent 48%),\n   radial-gradient(circle at 85% 72%, rgba(143, 196, 138, 0.22) 0, transparent 48%)",
            surface: "#fffaf7",
            border: "#f4ccc1",
            borderSoft: "#fde1d8",
            text: "#5b2e2a",
    ...
    9: {
        ...
        colors: {
            bg: "#fbf6ed",
            bgSoft: "#f1e3c4",
            bgPattern: "radial-gradient(circle at 12% 18%, rgba(214, 174, 94, 0.24) 0, transparent 48%),\n   radial-gradient(circle at 85% 72%, rgba(168, 132, 86, 0.18) 0, transparent 48%)",
            surface: "#fffaef",
            border: "#dec59a",
            borderSoft: "#ede1c2",
            text: "#4a3520",
    ...
    10: {
        ...
        colors: {
            bg: "#fff4e8",
            bgSoft: "#fbdcb6",
            bgPattern: "radial-gradient(circle at 12% 18%, rgba(232, 130, 51, 0.22) 0, transparent 48%),\n   radial-gradient(circle at 85% 72%, rgba(122, 96, 145, 0.18) 0, transparent 48%)",
            surface: "#fffaf2",
            border: "#f0c894",
            borderSoft: "#fbdcb6",
            text: "#4d2c12",
    ...
    11: {
        ...
        colors: {
            bg: "#fbf2ec",
            bgSoft: "#f1d7c0",
            bgPattern: "radial-gradient(circle at 12% 18%, rgba(199, 99, 56, 0.20) 0, transparent 48%),\n   radial-gradient(circle at 85% 72%, rgba(170, 132, 80, 0.18) 0, transparent 48%)",
            surface: "#fef7f0",
            border: "#dfbb97",
            borderSoft: "#ecd2b8",
            text: "#4a2a18",
    ...
    12: {
        ...
        colors: {
            bg: "#f1f7f3",
            bgSoft: "#dbe8df",
            bgPattern: "radial-gradient(circle at 12% 18%, rgba(72, 132, 89, 0.20) 0, transparent 48%),\n   radial-gradient(circle at 85% 72%, rgba(204, 70, 70, 0.18) 0, transparent 48%)",
            surface: "#f8fcf9",
            border: "#bbd2c1",
            borderSoft: "#d4e3d8",
            text: "#22332a",
...
export function getThemeByMonth(month) {
